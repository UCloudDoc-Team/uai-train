...
1.  准备好训练的代码，案例中训练代码在mnist/code下, 包括 **mnist\\\_cnn.py
    mnist\\\_datasets.py** 两个文件
2.  将keras\\\_tool.py 工具放入和训练代码目录同级的目录下，即mnist/ 目录下
3.  Ready To Pack
...
| project\\\_id          | 项目id                                                                                                  | 否                   |
| code\\\_path           | 训练任务所需代码路，以/结尾(请填写相对tf\_tool.py的相对路径，本例中为./code/)                                                     | 是                   |
...
注：我们可以将\~/uai\\-sdk/examples/keras/train/mnist/data/
...
打包的形式将软件包和相关数据打包入训练的Docker镜像，详细方法参见[userpack](/ai/uai-train/guide/keras/userpack)
