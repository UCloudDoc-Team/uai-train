...
如使用本例中[原始数据准备](uai-train/cases/obj-detect-tf/data)提供的图片数据集，则无需进行本节内容。以下流程将介绍如何使用自己的图片和数据构建数据集。
## 数据收集和记录
...
转至[数据格式转换](uai-train/cases/obj-detect-tf/data-trans)进行文件预处理。
