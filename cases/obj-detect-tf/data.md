...
[The Oxford-IIIT Pet
Dataset](http://www.robots.ox.ac.uk/%7Evgg/data/pets/)

宠物种类记录在一个文件中，用于训练和预测。 请下载本例中所用类别标签文件：

[pet\_label\_map.pbtxt](https://github.com/tensorflow/models/blob/master/research/object_detection/data/pet_label_map.pbtxt)
...
将物体类别标签文件重命名为label\_map.pbtxt，放在images和annotations的根目录（此处为/object-prep/）下，并记录此根目录：
