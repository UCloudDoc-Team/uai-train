...
* [实践场景](ai/uai-train/cases)
    * [CIFAR10图片分类](ai/uai-train/cases/cifar)
    ...
    * [基于TF-Slim的图片分类](ai/uai-train/cases/slim)
    ...
    * [物体分类retrain案例](ai/uai-train/cases/retrain)
    ...
    * [物体识别](ai/uai-train/cases/obj-detect-tf)
    ...
    * [CRNN-字符识别](ai/uai-train/cases/crnn)
    ...
    * [CRNN-中文字符识别](ai/uai-train/cases/crnn-chinese)
    ...
    * [图片转文字标注](ai/uai-train/cases/im2txt)
